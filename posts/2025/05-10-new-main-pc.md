...
簡易水冷は消耗部品ということらしいので、ハイエンドを投入するのではなく数年で置き換える前提でそこそこの値段で評判のよさそうな[ARCTIC Liquid Freezer III - 360](https://www.arctic.de/en/Liquid-Freezer-III-360/ACFRE00136A)を採用します。
